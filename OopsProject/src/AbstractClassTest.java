...
/*
 * What is an "abstract" class | incomplete
 * 
 * 
 */
...
//all above 4 funs are 2)inherited	
	void pluck() {
	}// 4) re-writing ( overridden )
}

//Aaditi
class Chess {// pawn,Rook, Bishop(camel), Knight, Queen, King
...
final class Disciple extends Master {
